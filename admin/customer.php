        ...
        */
        if($loggedIn && $_SERVER["REQUEST_METHOD"] == "POST")
        {
            ...
            if(isset($_POST["edit"]))
            {
                ...
                $email = $_POST["email"];
                $id = $_POST["id"];
                $id_if_customer_exists = exist_customers($conn,$cname,$cphone,$email);

                if(!$id_if_customer_exists || $id == $id_if_customer_exists)
                {
                    $updateSql = "UPDATE customers SET
                    customer_name = '$cname', 
                    customer_phone = '$cphone', email = '$email' WHERE customers.customer_id = '$id';";
                    ...
                    <table class="table table-hover table-bordered">
                        ...
                        <tr>
                            ...
                            <button class="button edit-button " data-link="<?php echo $_SERVER['REQUEST_URI']; ?>" data-id="<?php 
                                                ...
                                                echo $customer_phone;?>" data-email="<?php 
                                                echo $customer_email;?>"
                                                >Edit</button>
